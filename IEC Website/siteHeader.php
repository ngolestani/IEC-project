        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6 d-md-block d-none">
                    <p>+44 2070961212 --- info@edu.consultancy.com</p>
                </div>
                <div class="col-md-6">
                    <div class="d-flex justify-content-md-end justify-content-between">
                        ...
                        <div class="login">
                            ...
                            <a href="usersregister.php" class="signup-btn">
...
<!--            <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/logo2.png" alt="Universal logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>-->
...
<!--                                            <h5>User pages</h5>-->
<!--                                            <ul class="list-unstyled mb-3">-->
<!--                                                <li class="nav-item"><a href="usersregister.php" class="nav-link">Register / login</a></li>-->
