...
<div class="container">
<div class="row">
<form action="adminAddInstitute.php" method="post" class="col-lg-6">
				<div class="col-lg-6">
                ...
                <div class="col-lg-6">
				 ...
				 <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input id="courseId" value='<?php isset($courseId) ?  print $courseId : print "" ?>'
...
<!--                                      <td>-->
<!--                                      <td>-->
<!--                                          <button type="button" value="--><?php //print $res['id']?><!--" id="detach" class="btn btn-sm btn-danger">Detach Course</button>-->
<!--                                      </td>-->
<!--                                      </td>-->
<!--                                  </tr>-->
<!--                              --><?php //} ?>
