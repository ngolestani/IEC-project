        ...
        <div class="container">
            <table class="table table-striped table-sm mb-4 border-bottom">
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <a href="editCourse.php?id=<?php print $res['id'] ?> " class="btn btn-warning btn-sm float-left">Edit</a>
        ...
        if(query.length !=0) {
            if (query.length >= 2 || event.keyCode == 8) {
                ...
                result.forEach(function (value) {
                    ...
                    html += '<td>' + value[3] + '</td>';
                    html += '<td>'+
                        '<a href="editCourse.php?id=' +value[0]+'" class="btn btn-warning btn-sm float-left">Edit</a>'+
                        '<form action="deleteCourse.php" method="POST">'+
